...
const ROB_CHALLENGES = []; // 已清空以隐藏设置菜单中的擂台挑战英文列表
...
// };
const ROB_CHALLENGE_CN = {}; // 保留变量但置空
...
const cfgBattleSchema = {
    ...
    properties: [
        ...
        // mkF('autoStartBattle', 'boolean'), // 已注释：隐藏新一轮自动开战设置
        // mkF('autoEncounter', 'boolean'), // 已注释：隐藏自动遭遇战设置
        mkF('autoDawn', 'boolean'),
        mkF('notifyOnRiddle', 'boolean'),
        mkF('riddleAlarmLimit', 'number'), // 新增：警报次数的数字输入框
        // mkF('encounterDailyLimit', 'number'),
        // mkF('autoArena', 'boolean'), // 已注释：隐藏自动竞技场设置
        // mkF('arenaDailyLimit', 'number'),
        // mkF('autoRingOfBlood', 'boolean'), // 已注释：隐藏自动浴血擂台设置
...
function initEncounterWidget() {
    ...
    */
    ...
    /* 不将遭遇信息区加入 DOM，只保留配置菜单入口，避免面板出现空白区域 */
    ...
    */
    ...
    /* 去除默认的分割线和上方间距，只保留配置按钮 */
    settingsSection.style.borderTop = 'none';
    settingsSection.style.marginTop = '0';
    settingsSection.style.paddingTop = '0';
